...
![Node.js CI](https://github.com/Michaelndula/SSEMR3.x-Apps/actions/workflows/ci.yml/badge.svg)

# SSEMR 3.x custom packages

This repository contains frontend modules for the SSEMR 3.x. These modules relate to patient-flags, versioning and care-panels. The modules within this repository include:
